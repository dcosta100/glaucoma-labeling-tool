# ─────────────────────────────────────────────────────────────────────────────
# Glaucoma Progression Interface — main file : Last update September 1, 2025
# ─────────────────────────────────────────────────────────────────────────────
...
# --------------------------------------------------------------------------- #
# 2️⃣ Main interface in a FUNCTION
# --------------------------------------------------------------------------- #
def run_interface() -> None:
    ...
    # ------------  DB (optional) ----------------------------------------- #
    conn = sqlite3.connect("diagnosis_db.sqlite")
    conn.execute(
        """CREATE TABLE IF NOT EXISTS diagnosis
           (patient_id TEXT, specialist_name TEXT, diagnosis TEXT, comments TEXT)"""
    )
    conn.commit()
    ...
    ###***** If I wanted horizontal scroll too *****###
    # st.markdown(
    # """
    # <style>
    #     .scrollable-box {
    ...
    #         overflow:scroll;      /* scroll both vertically & horizontally */
    #         padding:10px;
    #         border:1px solid #ddd;
    #         white-space:nowrap;   /* keeps content in one line for horizontal scroll */
    #     }
    # </style>
    # """,
    # unsafe_allow_html=True,
